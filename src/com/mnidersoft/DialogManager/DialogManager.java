 ...
 * Manage different dialogs and contexts by one instance class
 * 
...
public class DialogManager {
	...
	public void makeAlert(int messageId, OnClickListener listener) {
		this.makeAlert(this.WARNING, this.context.getString(messageId), listener);
	}
	 ...
	 * @param yesListener Listener which be execute after click on yes button
	 */
	public void makeConfirm(int titleId, int messageId, OnClickListener yesListener) {
		this.dismiss();
		this.dialog = new AlertDialog.Builder(this.context)
		.setTitle(titleId)
		.setMessage(messageId)
	...
	public void makeConfirm(int messageId, OnClickListener yesListener) {
		this.makeConfirm(this.WARNING, this.context.getString(messageId), yesListener);
	}
